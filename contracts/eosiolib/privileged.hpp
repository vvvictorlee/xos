...
namespace eosio {
   ...
   uint64_t per_day_resource_usage_unlimit_threshold; ///< the base amount of transaction per day ,lower than the threshold, account's cpu and net usage donot billed 
      ...
      EOSLIB_SERIALIZE( blockchain_parameters,
                        ...
                        (max_inline_action_size)(max_inline_action_depth)(max_authority_depth)(per_day_resource_usage_unlimit_threshold)
      )
   };
