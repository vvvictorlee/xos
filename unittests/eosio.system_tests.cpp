...
fc::mutable_variant_object config_to_variant( const eosio::chain::chain_config& config ) {
   return mutable_variant_object()
      ...
      ("per_day_resource_usage_unlimit_threshold",config.per_day_resource_usage_unlimit_threshold);
}
...
BOOST_FIXTURE_TEST_CASE( setparams, eosio_system_tester ) try {
   ...
   params.per_day_resource_usage_unlimit_threshold +=30;
   ...
   BOOST_REQUIRE_EQUAL( params.per_day_resource_usage_unlimit_threshold, active_params.per_day_resource_usage_unlimit_threshold );
} FC_LOG_AND_RETHROW()
