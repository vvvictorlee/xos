...
/**
       ...
       *  .
       */
struct resoure_usage_per_day_accumulator
{

        resoure_usage_per_day_accumulator()
...
using usage_per_day_accumulator = impl::resoure_usage_per_day_accumulator;
...
class resource_limits_per_day_config_object : public chainbase::object<resource_limits_per_day_config_object_type, resource_limits_per_day_config_object>
{
        ...
        uint64_t per_day_resource_usage_unlimit_threshold = 0;
};
