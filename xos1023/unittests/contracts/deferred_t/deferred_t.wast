(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN10deferred_t9defercallEyyyy $_ZN10deferred_t9deferfuncEy)
 (memory $0 1)
 ...
 (data (i32.const 128) "deferfunc called on \00")
 (data (i32.const 160) " with payload = \00")
 (data (i32.const 192) "\n\00")
 (data (i32.const 208) "value 13 not allowed in payload\00")
 (data (i32.const 240) "bpcvb\00")
 (data (i32.const 256) "active\00")
 (data (i32.const 272) "eosio.token\00")
 (data (i32.const 288) "transfer\00")
 (data (i32.const 304) "voter\00")
 (data (i32.const 320) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 384) "invalid symbol name\00")
 (data (i32.const 416) "testinlinetoken\00")
 (data (i32.const 432) "write\00")
 (data (i32.const 448) "defercall called on \00")
 (data (i32.const 480) "deferred send of deferfunc action to \00")
 (data (i32.const 528) " by \00")
 (data (i32.const 544) " with sender id \00")
 (data (i32.const 576) "deferfunc\00")
  ...
  (block $label$13
   ...
   (block $label$21
    (br_if $label$21
     (i64.eq
      (get_local $2)
      (i64.const 5374671974817595392)
     )
    )
    (br_if $label$13
     (i64.ne
      (get_local $2)
      (i64.const 5374671912511733760)
     )
    )
    (i32.store offset=36
     (get_local $9)
    ...
    (drop
     (call $_ZN5eosio14execute_actionI10deferred_tS1_JyyyyEEEbPT_MT0_FvDpT1_E
      (i32.add
       (get_local $9)
       (i32.const 40)
      )
   ...
   (drop
    (call $_ZN5eosio14execute_actionI10deferred_tS1_JyEEEbPT_MT0_FvDpT1_E
     (i32.add
      (get_local $9)
      (i32.const 40)
     )
 ...
 (func $_ZN10deferred_t9defercallEyyyy (type $FUNCSIG$vijjjj) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64) (param $4 i64)
  (local $5 i64)
  (local $6 i32)
  (local $7 i32)
  (local $8 i64)
  ...
  (call $_ZNSt3__16vectorIN5eosio6actionENS_9allocatorIS2_EEE24__emplace_back_slow_pathIJNS1_16permission_levelERyyRN10deferred_t14deferfunc_argsEEEEvDpOT_
   (get_local $6)
   (i32.add
    (get_local $10)
    (i32.const 80)
 ...
 (func $_ZN5eosio14execute_actionI10deferred_tS1_JyyyyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i64)
 ...
 (func $_ZN10deferred_t9deferfuncEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (local $2 i64)
  (set_local $2
   (i64.load
    (get_local $0)
  ...
  (call $_ZN10deferred_t12testtransferEv
   (get_local $0)
  )
  (call $eosio_assert
   (i64.ne
 ...
 (func $_ZN5eosio14execute_actionI10deferred_tS1_JyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN10deferred_t12testtransferEv (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
 ...
 (func $_ZNSt3__16vectorIN5eosio6actionENS_9allocatorIS2_EEE24__emplace_back_slow_pathIJNS1_16permission_levelERyyRN10deferred_t14deferfunc_argsEEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
