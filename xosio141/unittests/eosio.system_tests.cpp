...
fc::mutable_variant_object config_to_variant( const eosio::chain::chain_config& config ) {
   return mutable_variant_object()
      ...
      ("resource_usage_per_day_unlimit_threshold",config.resource_usage_per_day_unlimit_threshold);
}
...
BOOST_FIXTURE_TEST_CASE( setparams, eosio_system_tester ) try {
   ...
   params.resource_usage_per_day_unlimit_threshold +=30;
   ...
   BOOST_REQUIRE_EQUAL( params.resource_usage_per_day_unlimit_threshold, active_params.resource_usage_per_day_unlimit_threshold );
} FC_LOG_AND_RETHROW()
