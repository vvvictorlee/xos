...
class resource_limits_per_day_config_object : public chainbase::object<resource_limits_per_day_config_object_type, resource_limits_per_day_config_object>
{
        ...
        uint64_t resource_usage_per_day_unlimit_threshold = config::default_resource_usage_per_day_unlimit_threshold;
};
...
FC_REFLECT(eosio::chain::resource_limits::resource_limits_per_day_config_object, (resource_usage_per_day_unlimit_threshold))
